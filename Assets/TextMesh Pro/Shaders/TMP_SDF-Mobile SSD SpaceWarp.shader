...
// - Screen-space derivative based SDF scaling with SpaceWarp motion vectors

Shader "TextMeshPro/Mobile/Distance Field SSD - SpaceWarp"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 PixShader(pixel_t input) : SV_Target
            {
                ...
                float layerBias = input.param.x * layerScale - .5 - ((_UnderlayDilate * _ScaleRatioC) * .5 *
                    layerScale);
                #endif
                ...
                faceColor += float4(_UnderlayColor.rgb * _UnderlayColor.a, _UnderlayColor.a) * saturate(d - layerBias) *
                    (1 - faceColor.a);
                #endif
                ...
                d = tex2D(_MainTex, input.texcoord2.xy).a * layerScale;
                faceColor += float4(_UnderlayColor.rgb * _UnderlayColor.a, _UnderlayColor.a) * (1 -
                    saturate(d - layerBias)) * sd * (1 - faceColor.a);
                #endif
        ...
        Pass
        {
            ...
            float4 PixShader(pixel_t input) : SV_Target
            {
                ...
                faceColor = lerp(outlineColor, input.faceColor,
                                     saturate(
                                         (d - input.param.x - input.param.z) * scale + 0.5));
                faceColor *= saturate((d - input.param.x + input.param.z) * scale + 0.5);
                #endif
 ...
 max(_UIMaskSoftnessY, _MaskSoftnessY));
                ...
                clip(faceColor.a * _XRMotionVectorsPass - 0.001);
